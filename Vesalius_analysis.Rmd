...
(here)[https://github.com/patrickCNMartin/Vesalius/blob/main/methodComp.R].
...
```{r Vesalius_BrainTerritories, eval=TRUE, echo=TRUE, warning= FALSE,message=FALSE,fig.width = 12, fig.height=8}
#-------------------/Territory Isolation - Hippocampus/------------------------#
