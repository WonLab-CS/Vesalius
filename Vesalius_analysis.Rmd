...
#------------------------------------------------------------------------------#
imageSlide <- utils::read.csv("~/group/slide_seqV2/IP/PCA_to_RGB_log_2000_slice1_Puck_200115_08.csv",
...
# NOTE: we can use the same raw data for both embryo slices used in
# this analysis
#------------------------------------------------------------------------------#
...
```{r Seurat_clustering_run, eval=FALSE , echo=TRUE,fig.width = 13.5, fig.height = 6}
#----------------------------/Seurat Clustering/-------------------------------#
#------------------------------------------------------------------------------#
...
imageBrain <- iterativeSegmentation.array(imageBrain, colDepth = 12,
                                          smoothIter = 20,
                                          method = c("iso","median"),
                                          sigma=1.5,box = 10,
                                          useCenter = T,
