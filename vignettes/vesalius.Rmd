...
vesalius <- smooth_image(vesalius, iter = 5, verbose = FALSE)
...
Vesalius will attempts to segment the images intocolor segments. 
...
vesalius <- segment_image(vesalius,method ="leiden", col_depth = 0.05, verbose = FALSE)
```
...
p6 <- territory_plot(vesalius, cex_pt = 2)
p6
```
