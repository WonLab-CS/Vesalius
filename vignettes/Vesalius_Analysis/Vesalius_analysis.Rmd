...
image <- buildImageArray(sec,filterGrid=1, resolution = 100, filterThreshold = 1)
...
g1 <-territoryPlot(image,cex = 15,cex.pt=2)+
   theme_void()+
   theme(legend.text = element_text(size = 12),
         legend.title = element_text(size=12),
         plot.title = element_text(size =15),
...
The same process was applied to another 10X Visium but this time in Kidney.
...
pdf("mouseKidney_Visium_vesalius.pdf", height= 8, width = 8)
g1 <-territoryPlot(image,cex = 15,cex.pt=3.5)+
   theme_void()+
   theme(legend.text = element_text(size = 12),
         legend.title = element_text(size=12),
         plot.title = element_text(size =15),
...
We also applied Vesalius in Human breast Visium 10X.
...
pdf("humanBreast_Visium_vesalius.pdf", height= 8, width = 8)
g1 <-territoryPlot(image,cex = 15,cex.pt=2.5)+
   theme_void()+
   theme(legend.text = element_text(size = 12),
         legend.title = element_text(size=12),
         plot.title = element_text(size =15),
...
This does not affect in anyway the downstream analysis. It only serve as a way of handling the data internally. We ran Vesalius on all 3 seqFISH embryo data sets availbale.
