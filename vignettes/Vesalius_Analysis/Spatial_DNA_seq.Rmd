...
```{r loading_and_building, eval = TRUE, echo  = TRUE}
...
```{r build_ves_assay, eval = TRUE, echo = TRUE}
...
```{ r viz_grey_dna, eval = TRUE, echo = TRUE}
...
```{r image_process_dna, eval = TRUE, echo = TRUE}
...
```{r grey_scale_processed, eval = TRUE, echo = TRUE, fig.width = 12, fig.height = 4}
...
```{r viz_dna_ter, eval = TRUE, echo = TRUE, fig.width = 9.5, fig.height = 8}
...
```{r quick_rna, eval = TRUE, echo = TRUE}
